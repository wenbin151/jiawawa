...
function(t) {
	...
	e.BINARY = "binary", e.TEXT = "text", e.VARIABLES = "variables", e.TEXTURE = "texture", e.SOUND = "sound", t.URLLoaderDataFormat = e, __reflect(e.prototype, "egret.URLLoaderDataFormat")
}(egret || (egret = {}));
var egret;
!
function(t) {
...
function(t) {
	...
	e.FRAME_LABEL = "frame_label", t.MovieClipEvent = e, __reflect(e.prototype, "egret.MovieClipEvent")
}(egret || (egret = {}));
var egret;
!
function(t) {
	...
	e.quintOut = e.getPowOut(5), e.quartOut = e.getPowOut(4), t.ScrollEase = e, __reflect(e.prototype, "egret.ScrollEase");
	var r = function(e) {
			function r(t, r, i) {
			...
			return __extends(r, e), r.get = function(t, e, i, o) {
				...
				var o = e._target,
					n = r._tweens;
				if (i) o && (o.tween_count = o.tween_count > 0 ? o.tween_count + 1 : 1), n.push(e), r._inited || (r._lastTime = t.getTimer(), t.sys.$ticker.$startTick(r.tick, null), r._inited = !0);
				else {
					o && o.tween_count--;
				...
				(n += a) != s;) {
					var l = this._actions[n],
						c = l.t;
					(c == o || c > i && o > c || r && c == t) && l.f.apply(l.o, l.p)
				}
				...
				for (var c in this._initQueueProps) {
					null == (s = i[c]) && (i[c] = s = this._initQueueProps[c]), null == (a = o[c]) && (o[c] = a = s), n = s == a || 0 == e || 1 == e || "number" != typeof s ? 1 == e ? a : s : s + (a - s) * e;
					var h = !1;
					if (l = r._plugins[c]) for (var u = 0, p = l.length; p > u; u++) {
						var _ = l[u].tween(this, c, n, i, o, e, !! t && i == o, !t);
						_ == r.IGNORE ? h = !0 : n = _
					}
					h || (this._target[c] = n)
				}
				...
				for (var a in t) {
					if (i = this._curQueueProps[a], e = r._plugins[a]) for (s = s || {}, o = 0, n = e.length; n > o; o++) e[o].step && e[o].step(this, a, i, t[a], s);
	...
	r._tweens = [], r.IGNORE = {}, r._plugins = {}, r._inited = !1, r._lastTime = 0, t.ScrollTween = r, __reflect(r.prototype, "egret.ScrollTween")
}(egret || (egret = {}));
var egret;
!
function(t) {
			...
			return __extends(r, e), Object.defineProperty(r.prototype, "bounces", {
				...
				if (void 0 === r && (r = !1), (!r || 0 != t || 0 != e) && (r || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
					...
					if (r) {
						...
						c || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))), (0 >= l || l >= n) && (l = Math.max(0, Math.min(l, n)))), this._ScrV_Props_._scrollTop = a, this._ScrV_Props_._scrollLeft = l
				...
				var r = e.prototype.$setWidth.call(this, t);
				return this._updateContentPosition(), r
				...
				for (var r = e.$target, i = this.$getPropagationList(r), o = i.length, n = .5 * i.length, s = -1, a = 0; o > a; a++) if (i[a] === this._content) {
					s = a;
					break
				}
				...
				if (0 != this._ScrV_Props_._velocitys.length) {
					...
					var s = t.x / e * this.scrollSpeed,
						...
						p = l > .02 ? this.getAnimationDatas(s, this._ScrV_Props_._scrollLeft, h) : {
							position: this._ScrV_Props_._scrollLeft,
							duration: 1
						},
						_ = c > .02 ? this.getAnimationDatas(a, this._ScrV_Props_._scrollTop, u) : {
				...
				var i = Math.abs(t),
					...
					a = .02,
					l = e + 500 * t;
				if (0 > l || l > r) for (l = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;) l += t, t *= 0 > l || l > r ? s * o : s, n++;
	...
	e.weight = [1, 1.33, 1.66, 2, 2.33], t.ScrollView = e, __reflect(e.prototype, "egret.ScrollView")
}(egret || (egret = {}));
var egret;
!
function(t) {
...
function(t) {
	...
	var r = function(r) {
			...
			return __extends(i, r), i.prototype.load = function(r) {
				...
				for (var s = r.requestHeaders.length, a = 0; s > a; a++) {
					var l = r.requestHeaders[a];
				...
				}, this), n.responseType = i.dataFormat == t.URLLoaderDataFormat.BINARY ? t.HttpResponseType.ARRAY_BUFFER : t.HttpResponseType.TEXT, n.send(r.data)
				...
				function o(r) {
					n(), e.data = l, window.setTimeout(function() {
						e.dispatchEventWith(t.Event.COMPLETE)
					}, 0)
				}
				function n() {
					l.removeEventListener(t.Event.COMPLETE, o, s), l.removeEventListener(t.IOErrorEvent.IO_ERROR, i, s), l.removeEventListener(t.ProgressEvent.PROGRESS, r, s)
				}
				var s = this,
					a = e._request.url,
					l = new t.Sound;
				l.addEventListener(t.Event.COMPLETE, o, s), l.addEventListener(t.IOErrorEvent.IO_ERROR, i, s), l.addEventListener(t.ProgressEvent.PROGRESS, r, s), l.load(a)
...
function(t) {
	var e = function(e) {
			function r(r) {
				var i = e.call(this) || this;
				return i.$bitmapData = null, i.offsetPoint = t.Point.create(0, 0), i.$movieClipData = null, i.frames = null, i.$totalFrames = 0, i.frameLabels = null, i.$frameLabelStart = 0, i.$frameLabelEnd = 0, i.frameEvents = null, i.frameIntervalTime = 0, i.$eventPool = null, i.$isPlaying = !1, i.isStopped = !0, i.playTimes = 0, i.$currentFrameNum = 0, i.$nextFrameNum = 1, i.displayedKeyFrameNum = 0, i.passedTime = 0, i.$frameRate = 0 / 0, i.lastTime = 0, i.$smoothing = t.Bitmap.defaultSmoothing, i.$renderNode = new t.sys.BitmapNode, i.setMovieClipData(r), i
			}
			return __extends(r, e), Object.defineProperty(r.prototype, "smoothing", {
				get: function() {
				...
				if (e) {
					var r = Math.round(this.offsetPoint.x),
						...
						h = e._sourceWidth,
						u = e._sourceHeight;
					t.sys.BitmapNode.$updateTextureData(this.$renderNode, e._bitmapData, e._bitmapX, e._bitmapY, o, n, r, i, s, a, l, c, h, u, null, t.BitmapFillMode.SCALE, this.$smoothing)
				}
				...
				if (r) for (var i = null, o = 0; o < r.length; o++) if (i = r[o], e ? i.name.toLowerCase() == t : i.name == t) return i;
				return null
			}, r.prototype.getFrameStartEnd = function(t) {
				var e = this.frameLabels;
				if (e) for (var r = null, i = 0; i < e.length; i++) if (r = e[i], t == r.name) {
					this.$frameLabelStart = r.frame, this.$frameLabelEnd = r.end;
					break
				}
			}, r.prototype.getFrameLabelByFrame = function(t) {
				var e = this.frameLabels;
				if (e) for (var r = null, i = 0; i < e.length; i++) if (r = e[i], r.frame == t) return r;
				return null
				...
				if (1 > s) return !1;
				for (; s >= 1;) {
					if (s--, r.$nextFrameNum++, r.$nextFrameNum > r.$totalFrames || r.$frameLabelStart > 0 && r.$nextFrameNum > r.$frameLabelEnd) if (-1 == r.playTimes) r.$eventPool.push(t.Event.LOOP_COMPLETE), r.$nextFrameNum = 1;
					else {
				...
				this.isStopped != e && (this.isStopped = e, e ? t.sys.$ticker.$stopTick(this.advanceTime, this) : (this.playTimes = 0 == this.playTimes ? 1 : this.playTimes, this.lastTime = t.getTimer(), t.sys.$ticker.$startTick(this.advanceTime, this)))
			}, r
		}(t.DisplayObject);
...
function(t) {
	...
	e.GET = "get", e.POST = "post", t.URLRequestMethod = e, __reflect(e.prototype, "egret.URLRequestMethod")
}(egret || (egret = {}));
var egret;
!
function(t) {
...
function(t) {
	var e = function(e) {
			function r() {
				var i = e.call(this) || this;
				return i._timeScale = 1, i._paused = !1, i._callIndex = -1, i._lastTime = 0, i.callBackList = [], null != r.instance, t.sys.$ticker.$startTick(i.update, i), i._lastTime = t.getTimer(), i
			}
...
function(t) {
	...
	e.deviceType = null, e.DEVICE_PC = "web", e.DEVICE_MOBILE = "native", e.RUNTIME_HTML5 = "runtimeHtml5", e.RUNTIME_NATIVE = "runtimeNative", t.MainContext = e, __reflect(e.prototype, "egret.MainContext")
}(egret || (egret = {}));
...
function(t) {
	var e = function(e) {
			...
			return __extends(r, e), r.$init = function() {
				t.sys.$ticker.$startTick(r.onUpdate, r)
	...
	e._callBackList = [], t.Recycler = e, __reflect(e.prototype, "egret.Recycler"), e.$init()
}(egret || (egret = {}));
var egret;
!
function(t) {
	function e(e, r, l) {
		for (var c = [], h = 3; h < arguments.length; h++) c[h - 3] = arguments[h];
		var u = {
			listener: e,
			thisObject: r,
			delay: l,
		...
		return s++, 1 == s && (a = t.getTimer(), t.sys.$ticker.$startTick(i, null)), n++, o[n] = u, n
	}
	function r(e) {
		o[e] && (s--, delete o[e], 0 == s && t.sys.$ticker.$stopTick(i, null))
	}
	function i(t) {
		var e = t - a;
		a = t;
...
function(t) {
	function e(e, r, l) {
		...
		return s++, 1 == s && t.sys.$ticker && (a = t.getTimer(), t.sys.$ticker.$startTick(i, null)), n++, o[n] = u, n
	}
	function r(e) {
		o[e] && (s--, delete o[e], 0 == s && t.sys.$ticker && t.sys.$ticker.$stopTick(i, null))
	}
	function i(t) {
		var e = t - a;
		a = t;
