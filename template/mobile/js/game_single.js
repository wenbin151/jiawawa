...
var rat=new Image(),
	...
	arrAnimals = [RatN,Rat1,TigerN,Tiger1,MonkeyN,Monkey1],
	//arrAnimals = [RatN,Rat1,TigerN,Tiger1,MonkeyN,Monkey1],
	tempArr=[],
	obj = {},
	score = 0,
...
var canvas = document.getElementById('canvas'),
	  ...
	  flag=0,
	  flagY = 0;
var sd=  parseInt(mc.resource.version) ? mc.resource.screenWidth[0]: mc.resource.screenWidth[1];
var stepAnimation=0;
var iframe=1;
...
var response = function(){
	...
	if(!parseInt(mc.resource.version)){
		arrAnimals.push(PrizeN);arrAnimals.push(Prize1);
